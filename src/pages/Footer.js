    ...
    return (
        <div className="w-[1440px] h-[493px] relative">
                ...
                <div className="w-[69px] h-[69px] left-0 top-0 absolute">
                    <img className="w-[69px] h-[69px] left-0 top-0 absolute" src="https://via.placeholder.com/69x69" />
                    <div className="w-[52px] h-11 left-[14px] top-[12px] absolute bg-white" />
                </div>
                </div>
                ...
                <div className="w-[29.60px] h-10 left-[19px] top-[14px] absolute">
                    <img className="w-[29.60px] h-10 left-0 top-0 absolute" src="https://via.placeholder.com/30x40" />
                    <div className="w-[33.60px] h-[44.80px] left-[-4px] top-[-3.20px] absolute bg-white" />
                </div>
                </div>
                <div className="w-[67px] h-[67px] left-[1317px] top-[64px] absolute">
                <div className="w-[67px] h-[67px] left-0 top-0 absolute bg-zinc-700 rounded-[10px]" />
                <img className="w-12 h-12 left-[10px] top-[12px] absolute" src="https://via.placeholder.com/48x48" />
                </div>
                <div className="w-[67px] h-[67px] left-[1230px] top-[64px] absolute">
                <div className="w-[67px] h-[67px] left-0 top-0 absolute bg-zinc-700 rounded-[10px]" />
                <img className="w-[47px] h-[31px] left-[10px] top-[21px] absolute" src="https://via.placeholder.com/47x31" />
                </div>
                <div className="w-[67px] h-[67px] left-[1141px] top-[64px] absolute">
                <div className="w-[67px] h-[67px] left-0 top-0 absolute bg-zinc-700 rounded-[10px]" />
                <img className="w-[43px] h-[43px] left-[12px] top-[12px] absolute" src="https://via.placeholder.com/43x43" />
                </div>
                ...
                <div className="w-[41.67px] h-[36.81px] left-[12.18px] top-[15.23px] absolute">
                    <img className="w-[41.67px] h-[36.81px] left-0 top-0 absolute" src="https://via.placeholder.com/42x37" />
                    <div className="w-[41.67px] h-[36.81px] left-0 top-0 absolute bg-white" />
                </div>
                </div>
            </div>
    )
